...
>(({ side = 'left', variant = 'sidebar', collapsible = 'offcanvas', children, ...props }, ref) => {
  ...
  if (collapsible === 'none') {
    return (
      <div className={'flex h-full w-[--sidebar-width] flex-col bg-sidebar text-sidebar-foreground'} ref={ref} {...props}>
        {children}
      </div>
    );
  }
...
const SidebarHeader = React.forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(({ className, ...props }, ref) => {
  return <div ref={ref} data-sidebar='header' className={'flex flex-col gap-2 p-2'} {...props} />;
});
SidebarHeader.displayName = 'SidebarHeader';

const SidebarFooter = React.forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(({ className, ...props }, ref) => {
  return <div ref={ref} data-sidebar='footer' className={'flex flex-col gap-2 p-2'} {...props} />;
});
SidebarFooter.displayName = 'SidebarFooter';

const SidebarSeparator = React.forwardRef<React.ElementRef<typeof Separator>, React.ComponentProps<typeof Separator>>(
  ({ className, ...props }, ref) => {
    return <Separator ref={ref} data-sidebar='separator' className={'mx-2 w-auto bg-sidebar-border'} {...props} />;
  }
);
...
const SidebarGroup = React.forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(({ className, ...props }, ref) => {
  return <div ref={ref} data-sidebar='group' className={'relative flex w-full min-w-0 flex-col p-2'} {...props} />;
});
...
const SidebarGroupContent = React.forwardRef<HTMLDivElement, React.ComponentProps<'div'>>(({ className, ...props }, ref) => (
  <div ref={ref} data-sidebar='group-content' className={'w-full text-sm'} {...props} />
));
SidebarGroupContent.displayName = 'SidebarGroupContent';

const SidebarMenu = React.forwardRef<HTMLUListElement, React.ComponentProps<'ul'>>(({ className, ...props }, ref) => (
  <ul ref={ref} data-sidebar='menu' className={'flex w-full min-w-0 flex-col gap-1'} {...props} />
));
SidebarMenu.displayName = 'SidebarMenu';

const SidebarMenuItem = React.forwardRef<HTMLLIElement, React.ComponentProps<'li'>>(({ className, ...props }, ref) => (
  <li ref={ref} data-sidebar='menu-item' className={'group/menu-item relative'} {...props} />
));
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    <div ref={ref} data-sidebar='menu-skeleton' className={'rounded-md h-8 flex gap-2 px-2 items-center'} {...props}>
